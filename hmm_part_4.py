...
def get_transition_matrix(tags_unique_with_start_stop, transition_pairs,
                          tag_seq_ls_with_start_stop):
...
for language in languages:
    ...
    transition_matrix = get_transition_matrix(tags_unique_with_start_stop,
                                              transition_pairs,
                                              tag_seq_ls_with_start_stop)
    ...
    save_prediction("p4", language, prediction)
